...
public class PostRestController {
    ...
    @PostMapping("/comment")
    public ApiResponse<String> addComment(@ValidUser @AuthenticationPrincipal AuthenticatedUser authenticatedUser,@RequestBody PostRequestDTO.AddCommentDTO requestDTO) {
    ...
    public ApiResponse<PostResponseDTO.EmojiResponseDTO> getEmojis(@ValidUser @AuthenticationPrincipal AuthenticatedUser authenticatedUser,@PathVariable("post_id") Long postId) {
...
//    }
    ...
    public ApiResponse<List<PostResponseDTO.TemplateDTO>> getUserTemplates(@ValidUser @AuthenticationPrincipal AuthenticatedUser authenticatedUser) {
