...
public interface PlanQueryService {
    ...
    PlanResponseDTO.LocationVerificationResponseDTO isUserInPlan(Long planId, Long userId, double userLat, double userLon, int type); // 특정 plan에서 사용자 위치 체크
    void schedulePlanVerification(Plan plan);
    void failPlan(Plan plan);
}
